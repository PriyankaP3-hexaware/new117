...
public class Employee {
  ...
  /**
   * empDeparmentName to store employee Deparment.
   */
  private String empDeparment;
  /**
   * empMgrId to store employee.
   */
  ...
  public final boolean equals(final Object obj) {
    ...
    if (Objects.equals(empId, emp.empId) && Objects.equals(empFullName, emp.empFullName)
        && Objects.equals(empMobile, emp.empMobile) && Objects.equals(empEmail, emp.empEmail)
        && Objects.equals(empDeparment, emp.empDeparment) && Objects.equals(empDateOfJoining, emp.empDateOfJoining)
        && Objects.equals(empMgrId, emp.empMgrId) && Objects.equals(empAvailableLeave, emp.empAvailableLeave)) {
      return true;
    }
    return false;
  }
  ...
  public final String toString() {
    return " EmpId:" + empId + " EmpName:" + empFullName + " EmpPhoneNo:"
             ...
             + empDeparment + " EmpJoinDate :" + empDateOfJoining + "EmpMgrId: "
