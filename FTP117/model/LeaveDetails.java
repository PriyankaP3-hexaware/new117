...
public class LeaveDetails {
  ...
  public static String applyLeave(final int argLeaveEmpId,
    ...
    if (noDays < 0) {
      res = "StartDate Must Be Smaller Than End Date....";
    } else if (dayDif < 0) {
      ...
      res = "start date must be greater than Current date";
    } else if (count == 1) {
      ...
      int balanceLeave = levAvail - argLeaveNoOfDays;
      edao().update(balanceLeave, argLeaveEmpId);
